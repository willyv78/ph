...
<div class="col-xs-11 col-sm-10 col-md-8 col-lg-6">
    ...
    <form id="form_cal" name="form_cal" action="" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                <input id="rmb_calendario_nom" type="text" name="rmb_calendario_nom" class="form-control" value="<?php echo $nom_even; ?>" <?php echo $disabled;?>>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 input-group date">
                <input class="form-control" id="rmb_calendario_fini" type="text" name="rmb_calendario_fini" value="<?php echo $fini_even; ?>" <?php echo $disabled;?>>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 input-group date">
                <input class="form-control" id="rmb_calendario_ffin" type="text" name="rmb_calendario_ffin" value="<?php echo $ffin_even; ?>" <?php echo $disabled;?>>
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9"><?php 
                ...
                <input class="form-control" type="file" name="rmb_calendario_img" id="rmb_calendario_img" placeholder="Imagen para mostrar en el evento" value="" <?php echo $disabled;?>>
            </div>
        </div>
        <div class="form-group">
            <label class="col-xs-12 col-sm-3 col-md-3 col-lg-3 control-label" for="rmb_calendario_desc">Observación:</label>
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                <textarea id="rmb_calendario_desc" name="rmb_calendario_desc" class="form-control" rows="3" placeholder="Realice una observación en 250 caractéres" <?php echo $disabled;?>><?php echo $obs_even; ?></textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                <div class="checkbox-emp">
                    <label>
                        <input id="rmb_context_id_pub" type="radio" <?php if(($pub_even == '1') || ($pub_even == '')){echo "checked='checked'";}?> name="rmb_context_id" value="1" <?php echo $disabled;?>> Público
                    </label>
                </div>
                <div class="checkbox-emp">
                    <label>
                        <input id="rmb_context_id_pri" type="radio" <?php if($pub_even == '2'){echo "checked='checked'";}?> name="rmb_context_id" value="2" <?php echo $disabled;?>> Privado
                    </label>
                </div>
            </div>
        </div>
