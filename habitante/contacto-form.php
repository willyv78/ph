...
<legend class="text-left col-xs-12 col-sm-12 col-md-12 col-lg-12" style="color: inherit;">Formulario de Contacto</legend>
<div class="clearfix">&nbsp;</div>
<form class="col-xs-12 col-sm-10 col-md-8 col-lg-6 form-quienes form-horizontal" id="form-contacto" name="form-contacto" method="POST" role="form" enctype="multipart/form-data"><?php 
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8 col-md-7 col-lg-6">
            ...
            <input type="hidden" name="rmb_context_id" id="rmb_context_id" class="form-control" value="2">
        </div>
    </div>
    <div class="form-group">
