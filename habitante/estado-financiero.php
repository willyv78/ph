...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    if($mes > 0){
        ...
        for($i = 1; $i <= $mes; $i++){
            ...
            $cont_meses .= '
                <div class="panel panel-default" data-toggle="collapse" href="#historial-financiero-'.$i.'" aria-expanded="false" aria-controls="historial-financiero-'.$i.'" style="text-align:left;">
                    ...
                    <div class="panel-heading">
                        ...
                        <span class="col-xs-5 col-sm-4 col-md-6 col-lg-4 text-nowrap modal-open text-right pull-right">Total $ '.number_format($valor_saldo_total).'</span>
                    </div>
