            ...
            <div class="hidden-xs col-sm-2 col-md-2 col-lg-1 pull-right text-right" id="nom-usu">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="hidden-xs col-sm-4 col-md-4 col-lg-4 text-center nav-cerrar">
                  <i href="#indexjquerytabs1-page-pass" data-original-title="Cambiar contraseña" data-toggle="tooltip" data-placement="left" title="Cambiar contraseña" alt="Cambiar contraseña" class="glyphicon glyphicon-lock menu_movil"></i>
                </div>
