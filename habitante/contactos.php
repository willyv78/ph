                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box_contac box-contac">
                        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                            <p class="text2_contac">
                                ...
                                <br />
                                <span class="textspan2_contac modal-open">
    ...
    <div class="box_contac form-contacto">
        <form class="form-horizontal" id="form_cal" action="" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <input id="rmb_mens_asunto" type="text" name="rmb_mens_asunto" class="form-control" value="" placeholder="Asunto">
                </div>
            </div>
            <div class="form-group">
