...
<div class='panel panel-default' data-toggle='collapse' href='#collapseExample5' aria-expanded='false' aria-controls='collapseExample5'>
    <div class='doc-est'>
        <img name="5" class="img-responsive" style="margin: auto; border-radius: 2px; padding: 5px 3px;" width="90%" alt="Reglamento del edificio" title="Reglamento del edificio"  src="../css/plantilla1/img/reglamento.png"/>
    </div>
...
<div class='panel panel-default' data-toggle='collapse' href='#collapseExample6' aria-expanded='false' aria-controls='collapseExample6'>
    <div class='doc-est'>
        <img name="6" class="img-responsive" style="margin: auto; border-radius: 2px; padding: 5px 3px;" width="90%" alt="Manual de convivencia" title="Manual de convivencia" src="../css/plantilla1/img/manual.png"/>
    </div>
    <div class='panel-heading'>
...
<div class='panel panel-default' data-toggle='collapse' href='#collapseExample2' aria-expanded='false' aria-controls='collapseExample2'>
    <div class='doc-est'>
        <img name="2" class="img-responsive" style="margin: auto; border-radius: 2px; padding: 5px 3px;" width="90%" alt="Circulares informativas" title="Circulares informativas" src="../css/plantilla1/img/circular.png"/>
    </div>
    <div class='panel-heading'>
...
<div class='panel panel-default' data-toggle='collapse' href='#collapseExample7' aria-expanded='false' aria-controls='collapseExample7'>
    <div class='doc-est'>
        <img name="7" class="img-responsive" style="margin: auto; border-radius: 2px; padding: 5px 3px;" width="90%" alt="Documentos administrativos" title="Documentos administrativos" src="../css/plantilla1/img/administrativo.png"/>
    </div>
    <div class='panel-heading'>
...
<div class='panel panel-default' data-toggle='collapse' href='#collapseExample4' aria-expanded='false' aria-controls='collapseExample4'>
    <div class='doc-est'>
        <img name="4" class="img-responsive" style="margin: auto; border-radius: 2px; padding: 5px 3px;" width="90%" alt="Documentos contables" title="Documentos contables" src="../css/plantilla1/img/contables.png"/>
    </div>
    <div class='panel-heading'>
...
<div class='panel panel-default' data-toggle='collapse' href='#collapseExample3' aria-expanded='false' aria-controls='collapseExample3'>
    <div class='doc-est'>
        <img name="3" class="img-responsive" style="margin: auto; border-radius: 2px; padding: 5px 3px;" width="90%" alt="Documentos fiscales" title="Documentos fiscales" src="../css/plantilla1/img/fiscales.png"/>
    </div>
    <div class='panel-heading'>
...
<div class='panel panel-default' data-toggle='collapse' href='#collapseExample1' aria-expanded='false' aria-controls='collapseExample1'>
    <div class='doc-est'>
        <img name="1" class="img-responsive" style="margin: auto; border-radius: 2px; padding: 5px 3px;" width="90%" alt="Actas de reuniones" title="Actas de reuniones" src="../css/plantilla1/img/actas.png"/>
    </div>
    <div class='panel-heading'>
