...
?>
<div class="text-left">
    <form id="form_autori" name="form_autori" action="" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center"><?php 
            ...
            <button id="cancelar" name="autorizadas.php" type="button" class="btn btn-default">Cancelar</button>
        </div>
        <div class="clearfix">&nbsp;</div>
    </form>
</div>
...
<script>
    $(document).ready(function($) {
        ...
        $('#form_autori').bootstrapValidator({
        ...
        .on('success.form.bv', function(e) {
            ...
            e.preventDefault();
            espereshow();
            var datos_form = new FormData($("#form_autori")[0]);
            $.ajax({
                url:"../php/ins_upd_autori.php",
                cache:false,
                type:"POST",
                contentType:false,
                data:datos_form,
