            ...
            <div class="table-responsive">
                <table class="table table-hover" id="tabla">
                    ...
                    while ($row_taptos = mysql_fetch_array($res_taptos)) {?>
                        <tr class="">
                            <td class='col-xs-7 col-sm-4 col-md-2 col-lg-2 text-center'><?php echo $row_taptos[1];?></td>
                            ...
                            <td class='col-xs-5 col-sm-4 col-md-4 col-lg-4 text-center'>
                                <div name="<?php echo $row_taptos[0];?>" class="input-group input-group-md btn_est">
