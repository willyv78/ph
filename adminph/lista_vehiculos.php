...
$res_autori = registroCampo("rmb_veh v", "v.rmb_veh_id, v.rmb_veh_placa, v.rmb_veh_marca, v.rmb_tveh_id", "WHERE v.rmb_aptos_id = '$apto_id'", "", "");
?>
<div class="panel-body">
    <table class="table table-hover">
        <thead>
            <tr>
                <th class='col-xs-7 col-sm-4 col-md-2 col-lg-3 text-center'>Placa</th>
                <th class='hidden-xs col-sm-4 col-md-3 col-lg-3 text-center'>Marca</th>
                <th class='hidden-xs hidden-sm col-md-3 col-lg-3 text-center'>Tipo</th>
            ...
            if(mysql_num_rows($res_autori) > 0){
                while ($row_autori = mysql_fetch_array($res_autori)) {?>
                    <tr class="">
                        ...
                        <td class='hidden-xs hidden-sm col-md-3 col-lg-3 text-center vertical-middle'><?php echo nombreCampo($row_autori[3], "rmb_tveh");?></td>
