...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 titulo-pagina">
   ...
   <button type="button" class="btn btn-default pull-right" alt="Nueva pregunta" title="Nueva pregunta" style="margin-top: 17px;">Nuevo</button>
</div>
    ...
    if(mysql_num_rows($res_question) > 0){
        while($row_question = mysql_fetch_array($res_question)){?>
            ...
            <div class='panel-body collapse' style="padding: 0;" id='collapseExample<?php echo $row_question[0];?>'>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 alert alert-info text-left">
                    <?php echo $row_question[2];?>
                    <div class="clearfix">&nbsp;</div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <button type="button" class="btn btn-default pull-right" data-id="<?php echo $row_question[0];?>">Eliminar</button>
                        <button type="button" class="btn btn-default pull-right" style="margin-right: 5px;" data-id="<?php echo $row_question[0];?>">Editar</button>
                    </div>
                </div>
            </div><?php 
        }
