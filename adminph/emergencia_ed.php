...
<div class="text-left">
    <form id="form_autori" name="form_autori" action="" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center"><?php 
            ...
            <button id="cancelar" name="emergencia.php" type="button" class="btn btn-default">Cancelar</button>
        </div>
        <div class="clearfix">&nbsp;</div>
    </form>
</div>
