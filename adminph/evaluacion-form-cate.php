...
if(isset($_GET['id_ver']) || isset($_GET['id_upd'])){
    ...
    $res_cate = registroCampo("rmb_eva_cate c", "c.rmb_eva_cate_id, c.rmb_eva_cate_nom", "WHERE c.rmb_eva_cate_id = $id_cat", "", "");
    if($res_cate){
...
<div class="text-left">
    <form id="form_cate_eva" name="form_cate_eva" action="" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <label class="col-xs-12 col-sm-2 col-md-3 col-lg-3 control-label" for="rmb_eva_cate_nom">Categoría: </label>
            <div class="col-xs-12 col-sm-9 col-md-8 col-lg-7">
                <input type="text" name="rmb_eva_cate_nom" id="rmb_eva_cate_nom" class="form-control" value="<?php echo $cate_nom;?>" placeholder="Peso de la categoría" alt="Peso de la categoría" title="Peso de la categoría" <?php echo $disabled;?>>
            </div>
        </div>
