...
$res_autori = registroCampo("rmb_residente_x_aptos rxa", "r.rmb_residente_id, r.rmb_residente_nom, r.rmb_residente_ape, r.rmb_vinculo_id, r.rmb_residente_vive, r.rmb_residente_tel, r.rmb_residente_cel, r.rmb_residente_foto, r.rmb_gen_id", "LEFT JOIN rmb_residente r USING(rmb_residente_id) WHERE rxa.rmb_aptos_id = '$apto_id' AND rxa.rmb_tres_id = '".$tipo_res."'", "", "");
            ...
            if(mysql_num_rows($res_autori) > 0){
                while ($row_autori = mysql_fetch_array($res_autori)) {
                    ...
                    <tr class="">
                        ...
                        <td class='hidden-xs hidden-sm col-md-3 col-lg-3 text-center'><?php echo $col_val_3;?></td>
