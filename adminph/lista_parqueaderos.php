...
$res_autori = registroCampo("rmb_parq p", "p.rmb_parq_id, p.rmb_parq_nom, t.rmb_torres_nom, z.rmb_zonas_nom", "LEFT JOIN rmb_zonas z USING(rmb_zonas_id) LEFT JOIN rmb_torres t USING(rmb_torres_id) WHERE p.rmb_aptos_id = '$apto_id'", "", "");
...
<div class="panel-body">
    <table class="table table-hover">
        <thead>
            <tr>
                <th class='col-xs-7 col-sm-4 col-md-2 col-lg-3 text-center'>Parqueadero</th>
