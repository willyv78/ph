...
$res_autori = registroCampo("rmb_mascotas m", "m.rmb_mascotas_id, m.rmb_mascotas_nom, m.rmb_mascotas_raza, m.rmb_tmascotas_id", "WHERE m.rmb_aptos_id = '$apto_id'", "", "");
?>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class='hidden-xs col-sm-4 col-md-3 col-lg-3 text-center'>Raza</th>
            ...
            if(mysql_num_rows($res_autori) > 0){
                while ($row_autori = mysql_fetch_array($res_autori)) {?>
                    <tr class="">
                        ...
                        <td class='hidden-xs hidden-sm col-md-3 col-lg-3 text-center'><?php echo nombreCampo($row_autori[3], "rmb_tmascotas");?></td>
