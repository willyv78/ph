...
<div class="text-left">
    <form id="form_depos" name="form_depos" action="" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center"><?php 
            ...
            <button type="submit" class="btn" alt="Ingresar / Actualizar datos del depósito" title="Ingresar / Actualizar datos del depósito" style="border: none;background-color: transparent;"><img src="../css/plantilla1/img/actualizar.png" alt=""></button>
        </div>
        <div class="clearfix">&nbsp;</div>
    </form>
</div>
