      ...
      <div class="navbar navbar-inverse navbar-fixed-top bs-docs-nav" role="banner" style="z-index: 3001;">
        <div class="containerk">
          ...
          <div class="navbar-header">
            ...
            <!-- Imagen central -->
            <div class="hidden-xs hidden-sm hidden-md col-lg-3 pull-left" id="logo-site">
               <img id="logo_edif" src="../images/logo.png" class="img-responsive" alt="Image">
            </div>
              ...
              <nav class="collapse navbar-collapse bs-navbar-collapse col-xs-12 col-sm-12 col-md-12 col-lg-12" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-right text-left">
                  ...
                  <li class="dropdown col-xs-12 col-sm-2 col-md-2 col-lg-2">
                    <a class="dropdown-toggle" data-toggle="dropdown">Apartamentos
                      <b class="caret"></b>
                    </a>
                  ...
                  <!-- Inventario, equipos y Mantenimiento -->
                  <li class="dropdown col-xs-12 col-sm-2 col-md-2 col-lg-2">
                    <!-- Nombre icono menu -->
                    <a class="dropdown-toggle" data-toggle="dropdown">Inventario
                      <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                      <li>
            ...
            <div class="hidden-xs col-sm-2 col-md-2 col-lg-1 pull-right text-right" id="nom-usu">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="hidden-xs col-sm-4 col-md-4 col-lg-4 text-right nav-cerrar">
                  <i href="#indexjquerytabs1-page-question" data-original-title="Preguntas Frecuentes" data-toggle="tooltip" data-placement="left" title="Preguntas Frecuentes" alt="Preguntas Frecuentes" class="glyphicon fa fa-question pull-right menu_movil" style="padding:2px 6px;font-size:1.5em;"></i>
                </div>
                <!-- icono de cambiar contraseña -->
                <div class="hidden-xs col-sm-4 col-md-4 col-lg-4 text-center nav-cerrar">
                  <i href="#indexjquerytabs1-page-pass" data-original-title="Cambiar contraseña" data-toggle="tooltip" data-placement="left" title="Cambiar contraseña" alt="Cambiar contraseña" class="glyphicon fa fa-lock menu_movil" style="padding:2px 6px;font-size:1.5em;"></i>
                </div>
