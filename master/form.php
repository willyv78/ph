...
<div class="col-xs-12 col-sm-10 col-md-10 col-lg-8 text-center" style="float:none;margin:auto;"><?php 
    							...
    							<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7"><?php 
    								if($tabla == 'rmb_tcont'){
    									if($row_val['COLUMN_NAME'] == 'rmb_tcont_icono'){
    										...
    										if($row_sql[$row_val['COLUMN_NAME']] != ''){
    											$src = base64_decode($row_sql[$row_val['COLUMN_NAME']]);
    										}?>
    										...
    										<input id="<?php echo $row_val['COLUMN_NAME'];?>" type="<?php echo $type;?>" name="<?php echo $row_val['COLUMN_NAME'];?>" class="form-control" value="<?php echo $row_sql[$row_val['COLUMN_NAME']];?>" ><?php 
    									}
    								}
    								elseif($tabla == 'rmb_contac'){
    									if($row_val['COLUMN_NAME'] == 'rmb_residente_id'){?>
    										<input type="hidden" name="rmb_residente_id" id="rmb_residente_id" class="form-control" value="1"><?php 
    									}
    								...
    								elseif($tabla == 'rmb_proyecto'){
    									...
    									elseif($row_val['COLUMN_NAME'] == 'rmb_proyecto_plantilla'){?>
    										<select class="form-control" name="rmb_proyecto_plantilla" id="rmb_proyecto_plantilla">
    									...
    									elseif($row_val['COLUMN_NAME'] == 'rmb_proyecto_obs'){?>
    										<textarea class="form-control" name="<?php echo $row_val['COLUMN_NAME'];?>" id="<?php echo $row_val['COLUMN_NAME'];?>" rows="5" cols="10"><?php echo $row_sql[$row_val['COLUMN_NAME']];?></textarea><?php 
    									}
    								...
    								elseif($tabla == 'rmb_depos'){
    									if($row_val['COLUMN_NAME'] == 'rmb_aptos_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_aptos");
    									}
    									elseif($row_val['COLUMN_NAME'] == 'rmb_zonas_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_zonas");
    									}
    								...
    								elseif($tabla == 'rmb_est'){
    									if($row_val['COLUMN_NAME'] == 'rmb_est_mod'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_mod");
    									}
    									else{?>
    										<input id="<?php echo $row_val['COLUMN_NAME'];?>" type="<?php echo $type;?>" name="<?php echo $row_val['COLUMN_NAME'];?>" class="form-control" value="<?php echo $row_sql[$row_val['COLUMN_NAME']];?>" ><?php 
    									}
    								...
    								elseif($tabla == 'rmb_tcal'){
    									if($row_val['COLUMN_NAME'] == 'rmb_tcal_color'){?>
    										<input type="color" name="rmb_tcal_color" id="rmb_tcal_color" class="form-control" value="<?php echo $row_sql[$row_val['COLUMN_NAME']];?>" title="Seleccione un color para mostrar en el calendario"><?php }
    									else{?>
    										<input id="<?php echo $row_val['COLUMN_NAME'];?>" type="<?php echo $type;?>" name="<?php echo $row_val['COLUMN_NAME'];?>" class="form-control" value="<?php echo $row_sql[$row_val['COLUMN_NAME']];?>" ><?php 
    									}
    								}
    								...
    								elseif($tabla == 'rmb_tpago'){
    									if($row_val['COLUMN_NAME'] == 'rmb_tpago_ope'){?>
    										<select class="form-control" name="rmb_tpago_ope" id="rmb_tpago_ope">
    											<option value="" <?php if($row_sql[$row_val['COLUMN_NAME']] == ''){echo "selected";} ?>>Seleccione...</option>
    								...
    								elseif($tabla == 'rmb_tvulnera'){
    									if($row_val['COLUMN_NAME'] == 'rmb_cvulnera_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_cvulnera");
    									}
    									else{?>
    										<input id="<?php echo $row_val['COLUMN_NAME'];?>" type="<?php echo $type;?>" name="<?php echo $row_val['COLUMN_NAME'];?>" class="form-control" value="<?php echo $row_sql[$row_val['COLUMN_NAME']];?>" ><?php 
    									}
    								...
    								elseif($tabla == 'rmb_zonas'){
    									if($row_val['COLUMN_NAME'] == 'rmb_torres_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_torres");
    									}
    									else{?>
    										<input id="<?php echo $row_val['COLUMN_NAME'];?>" type="<?php echo $type;?>" name="<?php echo $row_val['COLUMN_NAME'];?>" class="form-control" value="<?php echo $row_sql[$row_val['COLUMN_NAME']];?>" ><?php 
    									}
    								...
    								elseif($tabla == 'rmb_residente'){
    									if($row_val['COLUMN_NAME'] == 'rmb_tdoc_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_tdoc");
    									}
    									...
    									elseif($row_val['COLUMN_NAME'] == 'rmb_gen_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_gen");
    									}
    									elseif($row_val['COLUMN_NAME'] == 'rmb_perf_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_perf");
    									}
    									elseif($row_val['COLUMN_NAME'] == 'rmb_carg_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_carg");
    									}
    									elseif($row_val['COLUMN_NAME'] == 'rmb_est_id'){
    										echo campoSelect($row_sql[$row_val['COLUMN_NAME']], "rmb_est");
    									}
    									elseif($row_val['COLUMN_NAME'] == 'rmb_residente_hijo'){?>
    										<div class="radio">
    											<label>
    												<input type="radio" name="rmb_residente_hijo" id="rmb_residente_hijo1" value="1" checked="checked">
    												SI&nbsp;&nbsp;&nbsp;&nbsp;
    											</label>
    											<label>
    												<input type="radio" name="rmb_residente_hijo" id="rmb_residente_hijo0" value="0" checked="checked">
    												NO
    											</label>
    										</div><?php 
    									}
                                    ...
                                    elseif($tabla == 'rmb_banner'){
                                        ...
                                        elseif($row_val['COLUMN_NAME'] == 'rmb_est_id'){
                                            echo campoSelectEst($row_sql[$row_val['COLUMN_NAME']], "rmb_est", 11);
                                        }
	...
	<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center"><?php 
        	...
        	<button id="cancel" type="button" class="btn btn-default"><i class="glyphicon glyphicon-arrow-left"></i> Cancelar</button>
        </div>
    </div>
</div>
<script>
	$(function () {
	  ...
	  $('#rmb_residente_fini').datepicker({format: "yyyy-mm-dd", autoclose: true});
	  $('#rmb_residente_ffin').datepicker({format: "yyyy-mm-dd", autoclose: true});
	  cargaForm();
	});
</script>
